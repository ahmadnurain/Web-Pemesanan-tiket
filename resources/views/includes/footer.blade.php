<footer class="relative text-white overflow-hidden ">
    ...
    <div class="absolute -top-1 left-0 w-full overflow-hidden leading-[0]" aria-hidden="true">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none"
            class="relative block w-[calc(130%+1.3px)] h-10 text-slate-50">
            <path
                d="M985.66,92.83c-56.14,6.29-112.29,12.57-172,5.81C739.26,92.9,676,70,598.5,57.5S442.68,47,365.2,57.5C287.72,68,224.47,90.9,166.32,98.64,110.18,106,56,98.9,0,90.83V120H1200V95.8C1126,79,1041.8,86.54,985.66,92.83Z"
                fill="currentColor"></path>
        </svg>
    </div>

    <!-- Gradient background -->
    <div class="relative bg-gradient-to-r from-green-800 via-teal-700 to-emerald-600 py-16 px-24">
        <div
